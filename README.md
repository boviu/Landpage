...
•Abra o index.html diretamente em qualquer navegador (ou use a extensão Live Server no VS Code).

Tecnologias usadas:
•HTML5
•CSS3 (Flexbox, CSS Grid, Variáveis e Media Queries)
•Google Fonts (Fonte Inter)
•Font Awesome v6 (Ícones de contato)
•YouTube Embed (Vídeo pitch integrado)

Desenvolvedores:
Aurora Santos Gonçalves - 3B
Letícia Anti de Freitas Andrade - 3B
Lorena Rodrigues Marinho - 3B
Marina Yumi Shinomiya Brugnoli - 3B
